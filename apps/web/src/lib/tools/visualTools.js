...
toolRegistry.register({
    name: "create_chart",
    description: "Create a chart (bar, line, pie, scatter, doughnut) and save it as a PNG image. " +
    ...
    execute: async (args) => {
        ...
        const datasets = args["datasets"].map((ds, i) => ({
            ...ds,
        ...
        const chart = new Chart(ctx, {
            ...
            options: {
                ...
                animation: false,
                plugins: {
                    title: args["title"] ? { display: true, text: args["title"] } : undefined,
                    legend: { display: true },
                },
            },
        });
...
toolRegistry.register({
    name: "create_diagram",
    description: "Render a Mermaid diagram (flowchart, sequence, class, ER, Gantt, etc.) to SVG. " +
