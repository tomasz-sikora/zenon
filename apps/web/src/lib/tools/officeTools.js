...
toolRegistry.register({
    ...
    execute: async (args) => {
        ...
        await writeFile(path, bytes.buffer);
...
toolRegistry.register({
    ...
    execute: async (args) => {
        ...
        return { sheet: name, sheets: wb.SheetNames, rows: data, rowCount: data.length };
    },
});
// ─── Excel write ─────────────────────────────────────────────────────────────
toolRegistry.register({
...
toolRegistry.register({
    ...
    execute: async (args) => {
        ...
        return { rows, rowCount: rows.length, totalRows: result.data.length, fields: result.meta.fields };
    },
});
// ─── Word read ────────────────────────────────────────────────────────────────
toolRegistry.register({
