...
import { readFileText, writeFile, deleteFile, listDir, listDirRecursive, guessMime, } from "@/lib/storage/opfs";
toolRegistry.register({
    name: "read_file",
    description: "Read the text content of a file from the workspace. Returns the file content as a string.",
    inputSchema: {
        type: "object",
        properties: {
            path: {
...
toolRegistry.register({
    name: "list_files",
    description: "List files and directories at a given workspace path. Returns an array of file entries with name, type, and size.",
    inputSchema: {
        type: "object",
        properties: {
            path: {
